...
### Added
- Automated publication to the official MCP Registry for every tagged release.
- A version-controlled MCP Registry metadata template for the `.mcpb` package.

## [2.0.2] - 2026-09-05

### Changed
- Replaced the extension icon with Planny.
- Refined the README header, value proposition and installation presentation.
